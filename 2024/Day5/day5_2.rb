...
pages_input = false
order = {} # [a,b] => true, false b > a => true, default 0
pages = [] # Array of Array of ints

def sorted(a, o)
  a.sort { |p1, p2|  o[[p1 , p2]] || - o[[p2, p1]] } # Bug generator because I didn't consider ordering 
end
...
input_lines.each_with_index do |row, i|
  ...
  if pages_input
    ...
    order[[a,b].sort] = b > a ? -1 : 1 # Bug generator in ordering
  end
end
...
p grouped_pages[:incorrect].sum { |page| sorted(page, order)[page.size/2] }
